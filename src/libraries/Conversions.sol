...
library Conversions {
  ...
  function sqrtPriceX96ToUint(uint160 sqrtPriceX96, uint8 decimalsToken0) external pure returns (uint256) {
  ...
  function uintToSqrtPriceX96(uint256 priceToken1, uint8 decimalsToken0) external pure returns (uint160) {
